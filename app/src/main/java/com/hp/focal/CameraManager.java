...
public class CameraManager {
    ...
    private HashMap<String, String> mPendingParameters;
        ...
        public void run() {
            while (true) {
                synchronized (this) {
                    ...
                    HashMap<String, String> copy = new HashMap<String, String>(mPendingParameters);
    ...
    public CameraManager(Activity context) {
        ...
        mContext = context;
        mPendingParameters = new HashMap<String, String>();
    ...
    public void setParameterAsync(String key, String value) {
        ...
        synchronized (mParametersThread) {
            mPendingParameters.put(key, value);
            if (!mParametersBatch) {
                mParametersThread.notifyAll();
            }
        }
